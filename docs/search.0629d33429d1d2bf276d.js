...
var base = airtable__WEBPACK_IMPORTED_MODULE_0___default().base('appcttjzPgvmm4Gdx');
...
/* harmony import */ var _searchData_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(937);
...
var M_SearchBar = /*#__PURE__*/function (_React$Component) {
  _inherits(M_SearchBar, _React$Component);

  var _super = _createSuper(M_SearchBar);

  function M_SearchBar(props) {
    var _this;

    _classCallCheck(this, M_SearchBar);
    ...
    _defineProperty(_assertThisInitialized(_this), "handleKeyDown", function (event) {
      if (event.key === 'Enter' && _this.state.query.length >= 3) {
        _this.setSearchRequest(_this.state.query);
      }
    });

    _defineProperty(_assertThisInitialized(_this), "setSearchRequest", function (requestText) {
      var url = "".concat(window.location.origin, "/search.html");
      window.location.href = "".concat(url, "?request=").concat(encodeURIComponent(requestText));
    });

    _defineProperty(_assertThisInitialized(_this), "performSearch", /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return (0,_searchData_js__WEBPACK_IMPORTED_MODULE_2__/* .getPostTeasers */ .y)();

              case 3:
                data = _context.sent;
                filteredResults = data.filter(function (post) {
                  var titleMatches = post.title.toLowerCase().includes(query.toLowerCase());
                  var descriptionMatches = post.description.toLowerCase().includes(query.toLowerCase());
    ...
    _defineProperty(_assertThisInitialized(_this), "renderResults", function () {
      return _this.state.results.map(function (post) {
        ...
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h3", null, post.title), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, post.description)));
      });
    });

    _this.input = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createRef();
    _this.state = {
      query: '',
      results: []
    };
  ...
  _createClass(M_SearchBar, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;

      var params = new URLSearchParams(window.location.search);
      var requestParam = params.get('request');

      if (requestParam) {
        this.setState({
          query: decodeURIComponent(requestParam)
        }, function () {
          _this2.performSearch(_this2.state.query);
        });
      }
    }
  }, {
...
/* unused harmony default export */ var __WEBPACK_DEFAULT_EXPORT__ = ((/* unused pure expression or super */ null && (M_SearchBar))); // Рендеринг компонента на странице

var container = document.getElementById('A_Search');
var root = (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__/* .createRoot */ .s)(container);
root.render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(M_SearchBar, null));
})();
